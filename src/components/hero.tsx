...
export const Hero = () => {
  return (
    <div className="relative w-[177.78vh] h-screen md:w-screen md:h-[56.25vw] overflow-hidden">
      <iframe
        className="absolute top-0 left-0 w-[177.78vh] h-screen md:w-screen md:h-[56.25vw] object-cover pointer-events-none"
      ...
      <div className="relative z-10 flex flex-col items-start justify-center h-full px-8">
        ...
        <h1 className="text-white text-5xl max-w-[600px]">
